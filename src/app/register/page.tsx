    ...
    return (
        <div className="min-h-screen bg-dark flex items-center justify-center px-4">
            <div className="w-full max-w-md">
                ...
                {/* Card */}
                <div className="bg-card border-3 border-white shadow-brutal-white p-8">
                    <div className="brutal-tag inline-block mb-2">Get Started Free</div>
                    <h1 className="text-3xl font-grotesk font-black text-white mb-6">CREATE ACCOUNT</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="text-white/50 text-xs font-grotesk uppercase tracking-wide block mb-1">Full Name</label>
                            <input
                                type="text"
                                value={name}
                        ...
                        >
                            {loading ? "Creating account..." : <><Zap className="w-4 h-4" /> Create Account</>}
                        </button>
                    </form>

                    <p className="text-white/40 text-sm text-center mt-6 font-grotesk">
                        Already have an account?{" "}
                        <Link href="/login" className="text-lime hover:underline font-bold">
                            Sign in →
                        </Link>
                    </p>
                </div>
